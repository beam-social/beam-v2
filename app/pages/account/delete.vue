		...
		>
			...
			<form @submit.prevent="submit" class="flex flex-col gap-4">
				...
				<p class="text-sm text-muted">
					Cette action est irréversible. Après la suppression de votre
					compte, vous serez redirigé vers la page de connexion.
				</p>
				<button
					type="submit"
					class="bg-danger text-white px-4 py-2 rounded-lg hover:bg-danger-hovered transition"
				>
